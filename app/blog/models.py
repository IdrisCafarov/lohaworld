...
class GeneralSettings(models.Model):
    ...
    linkedin = models.CharField(
        max_length=1500, verbose_name="Linkedin", blank=True)
    instagram = models.CharField(
        max_length=1500, verbose_name="Instagram", blank=True)
    twitter = models.CharField(
        max_length=1500, verbose_name="Twitter", null=True, blank=True)
    slug = models.SlugField(editable=False, verbose_name="Slug")
    number_1 = models.CharField(
        max_length=100, verbose_name="Elaqe Nomresi", null=True)
    email = models.CharField(
        max_length=100, verbose_name="Email daxil edin", null=True, blank=True)
...
class Country(models.Model):
    ...
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, related_name="country")
...
class Service(models.Model):
    ...
    short_intro = models.CharField(
        max_length=80, verbose_name="Short Intro size: 80", null=True)
    content = RichTextField()
    slug = models.SlugField(editable=False, null=True, verbose_name="Slug")
